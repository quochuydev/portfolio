...
- Free version of resend account allows creating only 1 domains, it should be your main domain as a developer/company
...
![resend-create-API-key.png](../public/resend-create-API-key.png)

### Register domain

go to: https://resend.com/domains

![resend-domain-detail.png](../public/resend-domain-detail.png)
...
![wp-install-plugin.png](../public/wp-install-plugin.png)
...
![wp-update-smtp-config.png](../public/wp-update-smtp-config.png)
...
![woocommerce-setting-mail-1.png](../public/woocommerce-setting-mail-1.png)

![woocommerce-setting-mail-2.png](../public/woocommerce-setting-mail-2.png)
...
![woocommerce-setting-mail-1.png](../public/mail-template.png)
